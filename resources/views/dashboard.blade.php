...
<body>
    <div class="min-h-screen bg-[#FDEEDC] flex flex-col">
        ...
        <header class="flex items-center justify-between px-4 py-3">
            {{-- Hamburger --}}
            <button class="p-2 bg-black text-white rounded-md">
        ...
        <section class="px-6 py-8 max-w-lg m-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <!-- Card 2 -->
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <img src="{{ asset('images/cafe2.jpg') }}" alt="Cafe Brasserie" class="w-full h-40 object-cover">
                    <div class="p-3">
        ...
        <section class="px-6 py-10 max-w-lg m-auto">
            <!-- Item 1 -->
            <div class="bg-[#A63232] text-white p-6 md:p-10 rounded-lg mb-6 flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <!-- Item 2 -->
            <div class="bg-white text-[#A63232] border border-[#A63232] p-6 md:p-10 rounded-lg mb-6 flex flex-col md:flex-row items-start md:items-center justify-between">
