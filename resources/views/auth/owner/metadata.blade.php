<x-guest-layout>
    <form method="POST" action="{{ route('owner.metadata.store') }}" x-data="metadataForm()" enctype="multipart/form-data"
        ...
        <div x-data="{ currentStep: 1, restaurantName: '', restaurantAddress: '', description: '' }" class="max-w-2xl mx-auto space-y-6 py-8">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex-1 border-t-2 border-dashed"
                    :class="{ 'border-red-600': currentStep > 1, 'border-gray-300': currentStep <= 1 }"></div>
                ...
                <!-- Connector -->
                <div class="flex-1 border-t-2 border-dashed"
                    :class="{ 'border-red-600': currentStep > 2, 'border-gray-300': currentStep <= 2 }"></div>
            ...
            <div x-show="currentStep === 1" class="space-y-6 transition-all duration-300">
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        <label for="restaurant-name" class="block text-sm font-medium text-gray-700">Nama
                            Restoran</label>
                        <input id="restaurant-name" name="nama_restoran" x-model="restaurantName" type="text"
                            required
            ...
            <div x-show="currentStep === 3" class="space-y-6 transition-all duration-300">
                <div class="text-center">
                    <p class="text-gray-600">Langkah terakhir untuk mengaktifkan akun <span
                            x-text="restaurantName || 'Cafe Lorem'"></span> Anda.</p>
                </div>
