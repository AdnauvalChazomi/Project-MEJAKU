...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-lg bg-white shadow-md rounded-lg p-6">
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
            ...
            <div class="border-t mt-2 pt-2 flex justify-between font-semibold text-[#9D3935]">
                <span>Total</span>
        ...
        <div class="text-center">
            <button id="pay-button" class="bg-[#9D3935] text-white px-6 py-3 rounded-lg font-semibold hover:bg-red-700">
                Bayar Sekarang
            </button>
        </div>
    </div>
