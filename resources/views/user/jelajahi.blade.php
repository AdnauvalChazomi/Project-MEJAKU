        ...
        <form action="#" method="GET"
            ...
            <div class="relative w-full sm:w-80">
                <input type="text" placeholder="Cari berdasarkan nama atau lokasi..."
                    class="w-full px-4 py-2 pr-10 rounded-full border border-gray-300 focus:ring-2 focus:ring-[#A63232] focus:outline-none">

                {{-- Ikon Search --}}
                <button type="button"
                    class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#A63232] transition">
            ...
            <div x-data="{ open: false }" class="relative w-full sm:w-48">
                <button type="button" @click="open = !open"
                    class="w-full flex justify-between items-center px-4 py-2 rounded-full border border-gray-300 bg-white focus:ring-2 focus:ring-[#A63232] text-gray-700 hover:border-[#A63232] transition">
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-[#FDEEDC] hover:text-[#A63232] transition">Jambi</a>
                    <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-[#FDEEDC] hover:text-[#A63232] transition">Kota Jambi</a>
                    <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-[#FDEEDC] hover:text-[#A63232] transition">Sipin</a>
                    <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-[#FDEEDC] hover:text-[#A63232] transition">Telanai</a>
                </div>
            </div>
        </form>
    </div>
        ...
        @for ($i = 1; $i <= 8; $i++)
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:scale-[1.02] transition">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4">
                        <a href="#"
                            class="block text-center py-2 rounded-full bg-[#A63232] text-white font-medium text-sm hover:bg-[#8B2B2B] transition">
                            Lihat Detail
                        </a>
                    </div>
                </div>
