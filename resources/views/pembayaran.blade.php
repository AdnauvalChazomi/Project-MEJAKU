...
<div class="px-4 py-4 space-y-6">
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <div>
                <h3 class="font-semibold text-gray-800">Es Kopi Susu</h3>
                <p class="text-sm text-gray-600">Rp.28000</p>
            </div>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h3 class="font-semibold text-gray-800">Es Kopi</h3>
                <p class="text-sm text-gray-600">Rp.28000</p>
            </div>
            <span class="text-gray-800">1</span>
        </div>
    ...
    <div>
        ...
        <div class="bg-gray-100 rounded-lg p-3 cursor-pointer hover:bg-gray-200 transition-colors">
            <div class="flex justify-between items-center">
    ...
    <div class="bg-amber-100 rounded-lg p-3 border-l-4 border-amber-500">
        <div class="flex items-center">
            <i class="fas fa-gift text-amber-600 mr-2"></i>
            <span class="text-amber-800 font-medium">Hore! 1 Voucher Berhasil Digunakan</span>
            <i class="fas fa-chevron-right text-amber-600 ml-auto"></i>
        </div>
    </div>
