...
<div x-data="{ activeTab: 'tentang' }" class="relative max-w-lg mx-auto min-h-screen px-10 py-8">
    ...
    <div class="border-b border-gray-300 mb-8">
        <nav
            class="flex space-x-6 overflow-x-auto scrollbar-hide 
               sm:space-x-8 sm:overflow-x-visible">
            ...
            <button
                ...
                class="py-3 px-2 border-b-2 font-medium text-sm whitespace-nowrap focus:outline-none">
                {{ $label }}
            </button>
            @endforeach
