...
@section('content')
    <div class="max-w-2xl mx-auto p-6 bg-white shadow rounded-lg">
        ...
        <form action="{{ route('reservations.store.review', $owner->id) }}" method="POST"
        ...
        <div class="mt-8">
            ...
            <div class="mt-8">
                ...
                @forelse($reviews as $review)
                    <div class="flex items-start bg-gray-50 p-4 rounded-lg mb-4 shadow-sm">
                        <!-- Avatar user -->
                        <img src="{{ $review->user->avatar ?? 'https://cdn-icons-png.flaticon.com/512/2922/2922506.png' }}"
                            class="w-12 h-12 rounded-full mr-4" alt="{{ $review->user->name ?? 'User' }}">
