    ...
    <section>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            @foreach([
                ...
                ['icon' => 'https://cdn-icons-png.flaticon.com/512/857/857681.png', 'label' => 'Kelola Menu'],
                ['icon' => 'https://cdn-icons-png.flaticon.com/512/921/921594.png', 'label' => 'Kelola Pesanan'],
                ['icon' => 'https://cdn-icons-png.flaticon.com/512/833/833524.png', 'label' => 'Kelola Promo'],
            ] as $item)
            <a href="#"
                ...
                <img src="{{ $item['icon'] }}" class="w-10 h-10 opacity-90 group-hover:scale-110 transition-transform" alt="">
